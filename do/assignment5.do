 cd "C:\Users\barth\OneDrive\Desktop"
 
 import delimited "C:\Users\barth\OneDrive\Desktop\data_for_homework.csv", clear 
 
 

 regress y d unit time
 outreg2 using "C:\Users\barth\OneDrive\Documents\GitHub\assignment 5\table\reg_1.doc", word append
 
 
 
 regress demeaned_y demeaned_d time
 outreg2 using "C:\Users\barth\OneDrive\Documents\GitHub\assignment 5\table\reg_1.doc", word append
...
outreg2 using "C:\Users\barth\OneDrive\Documents\GitHub\assignment 5\table\reg_2.doc", word append
...
egen att_111 = mean(w4*ypost_1)
*egen att_10 = mean(w4*ypre)
egen att_011 = mean(w0*ypost_1)
*egen att_00 = mean(w0*ypre)

*Get ATT(2004, 2007)

gen att2004_2007 = (att_111 -att_10)-(att_011-att_00)
